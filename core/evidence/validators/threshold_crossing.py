...
def detect_threshold_crossings(
    ...
    *,
    ...
    """
    Detect indices where scores cross decision thresholds.

    Returns a dictionary mapping:
        threshold -> list of indices crossing that threshold
    """
    ...
    for t in thresholds:
        ...
        for i, s in enumerate(scores):
            if direction == "higher_is_better" and s >= t:
                crossings.append(i)
            elif direction == "lower_is_better" and s <= t:
                crossings.append(i)
        results[t] = crossings

    return results

    __all__ = ["detect_threshold_crossings"]
